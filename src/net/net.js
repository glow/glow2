...
Glow.provide(function(glow) {
	...
	*/
	...
	@private
	@function
	@description Adds random numbers to the querystring of a url so the browser doesn't use a cached version
	*/
	function noCacheUrl(url) {
		return url + (/\?/.test(url) ? "&" : "?") + "a" + new Date().getTime()
	}
	...
	*/
	...
	@param {Object} [opts]
		...
		@param {Boolean} [opts.cacheBust=false] Allow a cached response
			If true, a random number is added to the query string to ensure a fresh version of the file is being fetched
	...
	*/
	...
	@param {String} url
		Url to make the request to. This can be a relative path. You cannot make requests
		for files on other domains, to do that you must put your data in a javascript
		file and use {@link glow.net.getJsonp} to fetch it or see {@link glow.net.crossDomainPost}.
	@param {Object|String} data
		Data to post, either as a JSON-style object or a urlEncoded string
	@param {Object} [opts] Same options as {@link glow.net.get}
	...
	/**
		...
		@param {String} url Url to make the request to.
			This can be a relative path. You cannot make requests
			for files on other domains, to do that you must put your data in a javascript
			file and use {@link glow.net.loadScript} to fetch it.
		@param {Object|String} [data] Data to post, either as a JSON-style object or a urlEncoded string
